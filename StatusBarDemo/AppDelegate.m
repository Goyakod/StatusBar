...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ViewController *viewVontroller = [[ViewController alloc] init];
    
    //UIViewControllerBasedStatusBarAppearance设置为NO：在APPDelegate里设置的就有效，状态栏处处都是白色
    self.window.rootViewController = [[UINavigationController alloc] initWithRootViewController:viewVontroller];
    
    //若设置为YES(默认值) 就需要重写根视图的子类的child的方法才有效
